...
Tests successful login with credentials and verifies inventory page navigation.
"""
...
class TestSaucedemoLoginFlowPlayNotExist:
    """Test suite for saucedemo login functionality (via PlayNotExistAgent fallback)."""
